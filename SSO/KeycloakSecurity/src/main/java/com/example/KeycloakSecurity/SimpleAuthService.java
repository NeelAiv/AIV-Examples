package com.example.KeycloakSecurity;//package com.example.KeycloakSSO;
//
...
//    Map<String, Object> argobj = new HashMap<>();
//    String sql = null;
//    JdbcTemplate jdbc;
//    String deptCode;
//    String traceid;
...
//        } catch (Exception e) {
//            AuditLoggerUtil.log(AuditLoggerUtil.DBLOGGER, AuditLoggerUtil.ERROR, SimpleAuthService.class, e.getMessage(), traceid, deptCode, e);
//        }
//    }
//
//
...
//
//        sql = "select " +
//                "u.name as \"name\",u.email as \"email\",u.description as \"description\",u.dashboardOption as \"dashboardOption\",u.alertsOption as \"alertsOption\", "
//                + "u.reportOption as \"reportOption\",u.mergeReportOption as \"mergeReportOption\",u.adhocOption as \"adhocOption\",u.resourceOption as \"resourceOption\",u.quickRunOption as \"quickRunOption\",u.mappingOption as \"mappingOption\", "
//                + "u.messageOption as \"messageOption\",u.datasetOption as \"datasetOption\",u.parameterOption as \"parameterOption\",u.annotationOption as \"annotationOption\", "
//                + "u.notificationOption as \"notificationOption\",u.requestOption as \"requestOption\",u.adminOption as \"adminOption\",u.scheduleOption as \"scheduleOption\",u.webhookOption as \"webhookOption\" " +
...
//            argobj.putAll(data);
//
//            //insertUser.withTableName("\"" + deptCode + "\"." + "ai_user");
...
//                    + "adminOption=:adminOption,scheduleOption=:scheduleOption,webhookOption=:webhookOption,userType=:userType,landing_page=:landing_page,password=:password where userName=:userName and department=:deptcode";
//
//
...
//            argobj.putAll(data);
//
//            //inserRole.withTableName("\"" + deptCode + "\"." + "ai_role");
//            inserRole.usingColumns("name", "email", "description", "dashboardOption", "alertsOption", "reportOption", "mergeReportOption",
//                    "adhocOption", "resourceOption", "quickRunOption", "mappingOption", "messageOption", "datasetOption", "parameterOption",
//                    "annotationOption", "notificationOption", "requestOption", "adminOption", "scheduleOption", "webhookOption",
//                    "department");
//
...
//    }
//
//    public Map<String, Object> getAllDeptByName(String name) {
//        try {
//            argobj.clear();
//            argobj.put("name", name);
//
//            sql = "select " +
//                    "u.id as \"id\",u.deptname as \"deptname\",u.deptcode as \"deptcode\"" +
//                    " from ai_department as u where deptcode=:name";
//            return (Map<String, Object>) namedjdbc.queryForMap(sql, argobj);
//        } catch (Exception e) {
//            AuditLoggerUtil.log(AuditLoggerUtil.DBLOGGER, AuditLoggerUtil.ERROR, SimpleAuthService.class, e.getMessage(), this.traceid, this.deptCode, e);
//            return null;
...
//    }
//
//    public int updateRolesForUser(Map<String, Object> userRoleData, String updatedBy, String deptCode) {
//        deleteRolesForUser(userRoleData.get("userName").toString());
//        addRolesForUser(userRoleData);
//        return 1;
//    }
//
...
//    }
//
//    public Map<String, Object> getUserSecreByName(String userNameIN, String deptCode,String traceid) {
//
//        argobj.clear();
//        argobj.put("userName", userNameIN);
//        argobj.put("deptcode", deptCode);
...
//        try {
//
//            sql = "select u.password as \"password\" ,u.userName as \"userName\",u.status as \"status\",u.department as \"department\" from ai_user u where u.userName=:userName and u.department=:deptcode";
//            return (Map<String, Object>) namedjdbc.queryForMap(sql, argobj);
//
//        } catch (Exception e) {
//            AuditLoggerUtil.log(AuditLoggerUtil.DBLOGGER, AuditLoggerUtil.ERROR, SimpleAuthService.class, "User doesnt exist with name:" + userNameIN, this.traceid, this.deptCode, e);
...
//
//            sql = "select " +
//                    "u.id as \"id\",u.deptname as \"deptname\",u.deptcode as \"deptcode\" from ai_department as u where  u.deptcode =:deptcode";
//
//            Map<String, Object> m =  namedjdbc.queryForMap(sql, argobj);
//            return m != null ? true : false;
//        } catch (Exception e) {
//            AuditLoggerUtil.log(AuditLoggerUtil.DBLOGGER, AuditLoggerUtil.ERROR, SimpleAuthService.class, "Department not exists:" + deptCode, this.traceid, this.deptCode, e);
//            return false;
//        }
//    }
//
