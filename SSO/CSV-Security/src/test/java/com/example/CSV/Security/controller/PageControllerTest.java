...
class PageControllerTest {
    ...
    @Test
    @DisplayName("POST /{deptCode}/logout should redirect to the login page with a logout parameter")
    void handleAivLogout_ShouldRedirectToLoginPage() throws Exception {
        String deptCode = "Default";

        mockMvc.perform(post("/{deptCode}/logout", deptCode))
